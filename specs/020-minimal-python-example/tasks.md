...
- [X] T009 [P] [US3] `apps/python-wiki-demo/README.md`: one line near the top pointing to `apps/python-minimal-demo/` as the smallest demo (ten documents, no snapshot) for readers who want the recipe before the measured one

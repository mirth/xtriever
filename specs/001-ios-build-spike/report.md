...
**Status**: in progress — PR 1a complete, all gates green. | **Started**: 2026-09-10 | **Updated**: 2026-09-11
...
| FR-011 – FR-016 | Fixtures and oracles | **untested** — PR 1b |
...
| FR-031 – FR-033 | Provisional binding; bundled fp32 weights | **pass** (binding); weights **untested** until PR 1b |

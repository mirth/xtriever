...
- **Default budget**: 3,000 ms and re-rank depth 20 at the pipeline defaults *(re-rank depth 10
  since Feature 018 — `specs/018-demo-rerank-depth-10/report.md`)* — the plan sets

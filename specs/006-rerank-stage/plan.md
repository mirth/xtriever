...
└── tests/
    ...
    ├── rerank_prop.rs         # proptest: scored prefix sorted (score DESC, id ASC), suffix = fused minus scored, ⊆ fused, no duplicates, len ≤ k

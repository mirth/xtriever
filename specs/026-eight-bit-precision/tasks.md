...
- [X] T028 [US3] Record the measurement in `specs/026-eight-bit-precision/runs/`: `wikidemo measure` over the rebuilt corpus — parity against the new goldens, and the peak resident size against the 600 MB ceiling and the previous record (SC-005, FR-011) — **done**: `runs/measure-MacBookPro18,3-20260923T011736Z-mmap-threadsdefault-idle.json`, parity 800/800, peak `phys_footprint` 439.7 MB (the ceiling's measure, now recorded by `measure`), resident 638.2 MB beside it; the `f16` record kept as `…-compute-f16.json`

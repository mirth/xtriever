...
| `Sources/Xtriever/XtrieverData/` | the script's `--with-*` flags | models (51.5 MB: the eight-bit artefacts, Feature 026) and indexes pinned elsewhere by size and hash |
